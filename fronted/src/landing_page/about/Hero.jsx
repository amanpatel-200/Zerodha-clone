...
const Hero = () => {
  return (
    <div className='w-full  '>
     <h1 className='text-2xl  text-center mt-20'>We pioneered the discount broking model in India. <br />
Now, we are breaking ground with our technology.</h1>
       <div className='flex flex-col mt-30 px-10  border-t-2 border-gray-200 lg:px-30 lg:flex-row'>
         <div className='w-full lg:w-1/2 mt-20 text-xm '>
          ...
          <p className='mb-5'>Over 1.6+ crore clients place billions of orders every year through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.

</p>
         </div>
         <div className='w-full lg:w-1/2 lg:pl-5 mt-20 text-xm '>
